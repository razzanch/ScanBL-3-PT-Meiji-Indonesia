...
### 6. **Add Page**
   ...
   - Notifications for incomplete inputs or existing lot numbers.
   - **Clear** button to reset fields.

### 7. **Add Edit Page**
   - Used to continue adding data for existing lot numbers.
   - **Process Form**: Fields for **Product, No. Lot, Counter**.
   - **Main Form**: Fields for **Product, RSS Code, Jam Code, No. Lot, Date, Counter**.
   - Notifications for incomplete inputs or missing process form data.
...
1. Clone the repository:
   ...
   ```
2. Import the database schema from the `database` folder into your MySQL server.
3. Configure the database connection in `config.php`.
4. Deploy the application on a web server (e.g., Apache, Nginx).
